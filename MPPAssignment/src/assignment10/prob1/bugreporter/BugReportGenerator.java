package assignment10.prob1.bugreporter;
...
import assignment10.prob1.classfinder.ClassFinder;
...
public class BugReportGenerator {
	...
	private static final String PACKAGE_TO_SCAN = "assignment10.prob1.javapackage";
	...
	private void writeReport(String output) throws IOException {
		File reportFile = new File("src/assignment10/prob1/"+REPORT_NAME);
